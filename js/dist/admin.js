...
function (_Component) {
  ...
  _proto.view = function view() {
    ...
    }) : '', controls.length > 0 ? m(flarum_components_Dropdown__WEBPACK_IMPORTED_MODULE_5___default.a, {
...
function () {
  ...
  _proto.installExtension = function installExtension(extension) {
    ...
    flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.request({
      ...
      return _this.updateExtensionInRepository(response);
    }).catch(function () {
  ...
  _proto.uninstallExtension = function uninstallExtension(extension) {
    ...
    flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.request({
      ...
      return _this2.updateExtensionInRepository(response);
    }).catch(function () {
  ...
  _proto.favoriteExtension = function favoriteExtension(extension) {
    ...
    flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.request({
      ...
      return _this3.updateExtensionInRepository(response);
    }).catch(function () {
  ...
  _proto.updateExtension = function updateExtension(extension) {
    ...
    flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.request({
      ...
      return _this4.updateExtensionInRepository(response);
    }).catch(function () {
  ...
  _proto.toggleExtension = function toggleExtension(extension) {
    ...
    flarum_app__WEBPACK_IMPORTED_MODULE_0___default.a.request({
      ...
      return _this5.updateExtensionInRepository(response);
    }).catch(function () {
